...
function HeaderNav() {
  ...
  function toggleNightMode(e){
    setBodyClass((prevClass)=>{
      if(prevClass===''){
        prevClass = 'night-mode'
  ...
  return (
    <nav className="navbar mb-5 dens-nav-style justify-content-between">
        <div className="container">
            <div className="nav-left-elems d-flex justify-content-between">
                <Link to="/" className="navbar-brand">РИЛИ мета</Link>
            </div>
        
      <div className="tumbler-wrapper" onClick={toggleNightMode}>
